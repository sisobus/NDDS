...
public:
   ...
   void find_entries_by_hamming_dist(const Leaf_entry &query_data, int range, vector<int>& block_numbers_in_range,int &number_of_dist_computation);
...
private:
   ...
   bool is_within_Hamming_dist(const Leaf_entry &query_data, unsigned char* DMBR, int range,int &number_of_dist_computation);
...
void Dir_node::find_entries_by_hamming_dist(const Leaf_entry &query_data, int range, vector<int>& block_numbers_in_range,int &number_of_dist_computation){
   int i;



   for(i = 0; i < count; i++){
      if(is_within_Hamming_dist(query_data, entriesVec.at(i).DMBR, range,number_of_dist_computation)){ 
...
bool Dir_node::is_within_Hamming_dist(const Leaf_entry &query_data, unsigned char* DMBR, int range,int &number_of_dist_computation){
   int i;
   int byte_no, bit_no;
